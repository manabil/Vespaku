      ...
      <div class="entries">
        ...
        <article class="entry entry-single">
          <div class="row">
              ...
              <div class="col-lg-8">
                  <h1 class="entry-heading">Martha Mutatulis</h1>
                  <h5>NIP : 19920926207105568</h5>
                  <h5>Pangkat : Pembina TK I / IV B</h5>
                  <h5>Jabatan : <strong>Administrator</strong> - Analisis Pengelolaan Keuangan APBN Ahli Pertama</h5>
                  <h5>Email : Justin@bpmpk.gov.id</h5>
